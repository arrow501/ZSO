...
#define NUM_CUSTOMERS 5 // Any positive integer
#endif

/* Maximum number of concurrent customers in the shop */
#ifndef MAX_CONCURRENT_CUSTOMERS
#define MAX_CONCURRENT_CUSTOMERS 5 // Any positive integer, larger values may not be compatible with your system
#endif
